...
Vaisseau atlanta = {1,"SS Atlanta", 1, 0, 0, 60, 20, 100, 10, 600, {1,1,1,0,0}};
			...
			case 1:
				switch (w->state[i]) {
					case 0:
						...
						break;
					case 1:
						strcpy(milieuPrint[i], "\e[1;33m■\e[0m");
						break;
					case 2:
						strcpy(milieuPrint[i], "\e[0m►\e[0m");
						break;
			...
			case 2:
				switch (w->state[i]) {
					case 0:
						...
						break;
					case 1:
						strcpy(milieuPrint[i], "\e[0;32m■\e[0m");
						break;
					case 2:
						strcpy(milieuPrint[i], "\e[0m►\e[0m");
						break;
			...
			case 3:
				switch (w->state[i]) {
					case 0:
						...
						break;
					case 1:
						strcpy(milieuPrint[i], "\e[0;35m■\e[0m");
						break;
					case 2:
						strcpy(milieuPrint[i], "\e[0m►\e[0m");
						break;
			...
			case 4:
				switch (w->state[i]) {
					case 0:
						...
						break;
					case 1:
						strcpy(milieuPrint[i], "\e[0;34m■\e[0m");
						break;
					case 2:
						strcpy(milieuPrint[i], "\e[0m►\e[0m");
						break;
